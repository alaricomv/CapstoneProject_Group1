...
export const PRODUCT_BY_ID_IRL = BASE_URL + '/ordersbystore/';
...
export const PRODUCT_BY_NAME_URL = BASE_URL + '/productsbyname/';
export const PRODUCT_BY_TAG_URL = BASE_URL + '/productsbytag/';
